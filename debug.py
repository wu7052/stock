...
wx.info(
    "============================[update_daily_data_from_eastmoney]当日交易数据==========================================")
...
wx.info(
    "============================[update_last_day_qfq_data_from_ts]更新个股前复权数据==========================================")
...
wx.info(
    "============================[update_ind_ma_single]当日个股前复权数据指标（个股全部更新）==========================================")
...
"""
wx.info(
    "============================[update_whole_sales_data_from_eastmoney]大宗交易数据==========================================")
...
"""
wx.info(
    "============================[update_dgj_trading_data_from_eastmoney]董高监交易数据==========================================")
