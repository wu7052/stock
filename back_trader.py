...
bt = back_trader(f_date='20190808', f_days=-180,  f_name='filter_rules\\filter_001.conf')
...
filter_ret_df = pd.read_excel("D:\\JetBrains\\stock_analyzer\\report\\20190818_选股清单_bt_qfq.xlsx")
